        ...
        <div className="hidden md:flex items-center space-x-8">
          {navLinks.map((link) => (
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  'text-white hover:text-[#FF5722] transition-colors duration-300 link-hover text-sm font-medium tracking-wide',
                  isActive && 'text-[#FF5722] after:w-full'
                )
              }
            >
              {link.name}
        ...
        <div className="flex flex-col space-y-4">
          {navLinks.map((link) => (
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  'text-white hover:text-[#FF5722] py-2 text-xl transition-colors duration-300',
